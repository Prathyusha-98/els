    ...
    return(
      ...
      <div className='mx-4 md:mx:12 lg:mx-12 md:mb-56 lg:mb-56 mb-20'>
        ...
        <p className='text-sm md:text-2xl lg:text-2xl '>Questions or concerns?ÊReading this privacy notice will help you understand your privacy rights and choices. If you do not agree with our policies and practices, please do not use our Services. If you still have any questions or concerns, please contact us at yiukins@gmail.com.</p>
                    ...
                    <ol>
                        <li className='text-sm md:text-2xl lg:text-2xl'><a className=" hover:text-blue-600 dark:hover:bg-indigo-700" href="https://mysecondhome.com.au/simplemail-privacy-statement/#infocollect">1. WHAT INFORMATION DO WE COLLECT?</a></li>
                        <li className='text-sm md:text-2xl lg:text-2xl'><a className="hover:text-blue-600 dark:hover:bg-indigo-700" href="https://mysecondhome.com.au/simplemail-privacy-statement/#infouse">2. HOW DO WE PROCESS YOUR INFORMATION?</a></li>
                        <li className='text-sm md:text-2xl lg:text-2xl'> <a className="hover:text-blue-600 dark:hover:bg-indigo-700" href="https://mysecondhome.com.au/simplemail-privacy-statement/#legalbases">3. WHAT LEGAL BASES DO WE RELY ON TO PROCESS YOUR PERSONAL INFORMATION?</a> </li>
                        <li className='text-sm md:text-2xl lg:text-2xl' > <a className="hover:text-blue-600 dark:hover:bg-indigo-700" href="https://mysecondhome.com.au/simplemail-privacy-statement/#whoshare">4. WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</a> </li>
                        <li className='text-sm md:text-2xl lg:text-2xl'> <a className="hover:text-blue-600 dark:hover:bg-indigo-700" href="https://mysecondhome.com.au/simplemail-privacy-statement/#inforetain">5. HOW LONG DO WE KEEP YOUR INFORMATION?</a> </li>
                        <li className='text-sm md:text-2xl lg:text-2xl'> <a className="hover:text-blue-600 dark:hover:bg-indigo-700" href="https://mysecondhome.com.au/simplemail-privacy-statement/#infosafe">6. HOW DO WE KEEP YOUR INFORMATION SAFE?</a> </li>
                        <li className='text-sm md:text-2xl lg:text-2xl'> <a className="hover:text-blue-600 dark:hover:bg-indigo-700" href="https://mysecondhome.com.au/simplemail-privacy-statement/#privacyrights">7. WHAT ARE YOUR PRIVACY RIGHTS?</a> </li>
                        <li className='text-sm md:text-2xl lg:text-2xl'> <a className="hover:text-blue-600 dark:hover:bg-indigo-700" href="https://mysecondhome.com.au/simplemail-privacy-statement/#DNT">8. CONTROLS FOR DO-NOT-TRACK FEATURES</a> </li>
                        <li className='text-sm md:text-2xl lg:text-2xl'> <a className="hover:text-blue-600 dark:hover:bg-indigo-700" href="https://mysecondhome.com.au/simplemail-privacy-statement/#caresidents">9. DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</a> </li>
                        <li className='text-sm md:text-2xl lg:text-2xl'> <a className="hover:text-blue-600 dark:hover:bg-indigo-700" href="https://mysecondhome.com.au/simplemail-privacy-statement/#policyupdates">10. DO WE MAKE UPDATES TO THIS NOTICE?</a> </li>
                        <li className='text-sm md:text-2xl lg:text-2xl'> <a className="hover:text-blue-600 dark:hover:bg-indigo-700" href="https://mysecondhome.com.au/simplemail-privacy-statement/#contact">11. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</a> </li>
                        <li className='text-sm md:text-2xl lg:text-2xl'> <a className="hover:text-blue-600 dark:hover:bg-indigo-700" href="https://mysecondhome.com.au/simplemail-privacy-statement/#request">12. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</a> </li>
                    </ol>
