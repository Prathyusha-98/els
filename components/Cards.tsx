    ...
    <div className='bg-[#D9DEFF] w-full xs:h-[477px] sm:h-[848px] md:h-[848px] lg:hidden md:block sm:block xs:block'>
        <div >
          ...
          <div className="flex justify-center items-center md:pt-[24px] sm:pt-[24px] xs:pt-0">
            <div className="flex md:w-[252px] md:h-[297px] sm:w-[252px] sm:h-[297px] xs:w-[142px] xs:h-[167px] flex-col justify-center items-center flex-shrink-0 xs:rounded-2xl sm:rounded-2xl md:rounded-3xl bg-white bg-opacity-60 m-6">
              <div className="text-[#1E1E1E] text-center font-poppins text-lg font-medium leading-normal">
            ...
            <div className="flex md:w-[252px] md:h-[297px] sm:w-[252px] sm:h-[297px] xs:w-[142px] xs:h-[167px] lg:w-[200px] lg:h-[300px] flex-col justify-center items-center flex-shrink-0 xs:rounded-2xl sm:rounded-2xl md:rounded-3xl bg-white bg-opacity-60 m-6">
              <div className="text-[#1E1E1E] text-center font-poppins text-lg font-medium leading-normal">
                <div className="flex justify-center items-center xs:pt-6">
