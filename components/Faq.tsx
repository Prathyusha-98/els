...
const Faqitem = ({question} : {question: { title: string, text: string, images?: (string | StaticImageData)[]}}) =>{
    ...
    return(
        <div className="xl:w-[925px] 2xl:w-[1150px] 3xl:w-[1212px]  md:w-[595px] lg:w-[595px] sm:w-[400px] xs:w-[320px]  px-4 pb-5">
            <button onClick={openquestion} className="text-xl xs:text-left text-[#134A50] border-b-2  border-b-[#1E1E1E]   w-full flex justify-between px-4 py-3">
